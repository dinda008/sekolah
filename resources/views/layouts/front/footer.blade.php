<footer id="footer" class="footer position-relative" style="background-color: #2c3e50; color: #fff;">
  ...
  <div class="container copyright text-center mt-4">
    <p>© <span>Copyright SMP NEGERI 2 PRAJEKAN 2025</span></p>
    <div class="credits">
      Designed by Adinda Eka Mayang Wijayanti
    </div>
  </div>
