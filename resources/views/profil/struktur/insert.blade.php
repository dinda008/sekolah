...
@section('title', 'add struktur_sekolah')
    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">TAMBAH DATA STRUKTUR ORGANISASI SEKOLAH</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('profil.struktur.tambah_struktur.insert') }}" method="POST" enctype="multipart/form-data">
                    @csrf 
