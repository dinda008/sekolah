...
<style>
    ...
    /* Modal styles */
    .modal {
        display: none; /* HARUS disembunyikan awalnya */
        position: fixed;
        z-index: 1050;
        inset: 0;
    ...
    cursor: pointer;
    z-index: 1100;
    display: none; /* ini supaya awalnya tersembunyi */
    transition: 0.3s;
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll(".popup-img").forEach(function (imgLink) {
        imgLink.addEventListener("click", function (e) {
            ...
            modal.style.display = "flex"; // tampilkan modal saat klik
        });
    });

    closeBtn.onclick = function () {
        modal.style.display = "none";
        modalImg.src = ""; // bersihkan src supaya tidak tersimpan
    };
